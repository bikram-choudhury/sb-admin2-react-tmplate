...
> This is the **demo version for [sb-admin-2](https://startbootstrap.com/themes/sb-admin-2) template**. i.e: (_does not contain all views or features of the original template_)
