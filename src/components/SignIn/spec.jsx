...
describe('SignUp Component', () => {
    ...
    it('handleSubmit should get call on form submit', () => {
        ...
        expect(component.find('input[name="username"]').prop('aria-invalid')).toBeFalsy();
    ...
    it('signInFormOnSubmit should call authenticateUser', () => {
        ...
        expect(AuthApi.authenticateUser).toHaveBeenCalledWith(expectedData, dispatch);
    });
    ...
    describe('Errors handling', () => {
        ...
        it('should show error', () => {
            ...
            expect(component.find('input[name="username"]').prop('aria-invalid')).toBeTruthy();
            expect(component.find('input[name="password"]').prop('aria-invalid')).toBeTruthy();
        })
    });
});